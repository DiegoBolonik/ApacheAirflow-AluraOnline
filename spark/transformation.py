'''com esse objeto spark, nós podemos começar a ler os dados do nosso data lake. O trabalho Spark, recebendo, criando a sessão dele, lendo usando o comando read em um dataframe, vendo as informações básicas dele'''
import argparse
